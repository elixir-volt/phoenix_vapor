...
import { toDisplayString as _toDisplayString, createElementVNode as _createElementVNode, openBlock as _openBlock, createElementBlock as _createElementBlock, Fragment as _Fragment, createCommentVNode as _createCommentVNode, renderList as _renderList } from "vue"
...
return (_ctx, _cache) => {
  return (_openBlock(), _createElementBlock("div", null, [
    ...
    _createElementVNode("select", {
      ...
      _hoisted_1,
      _hoisted_2
    ], 40 /* PROPS, NEED_HYDRATION */, ["value"]),
    _createElementVNode("button", { onClick: clearSearch }, "Clear"),
    _createElementVNode("p", null, _toDisplayString(filtered.value.length) + " of " + _toDisplayString(props.contacts.length) + " contacts", 1 /* TEXT */),
    (selectedCount.value > 0)
      ? (_openBlock(), _createElementBlock("p", { key: 0 }, _toDisplayString(selectedCount.value) + " selected", 1 /* TEXT */))
      : _createCommentVNode("v-if", true),
    _createElementVNode("ul", null, [
      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(filtered.value, (contact) => {
    ...
    (showDialog.value)
      ? (_openBlock(), _createElementBlock("div", { key: 1 }, [
        _hoisted_3,
        _createElementVNode("button", { onClick: closeDialog }, "Cancel")
      ]))
      : _createCommentVNode("v-if", true),
    _createElementVNode("button", { onClick: openDialog }, "Open Dialog"),
    _createElementVNode("button", { onClick: deleteSelected }, "Delete Selected")
  ]))
}
}
